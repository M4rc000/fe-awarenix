...
export default function NewCampaignModalForm() {
  ...
  const toggleSelectCard   = (idx: number) => {
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <div className="flex items-center gap-2">
            ...
            <div className="border rounded-md px-2 py-1 bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-sm text-gray-800 dark:text-gray-200">
              English
            </div>
          </div>
          <div className="flex items-center gap-2">
